...
pub fn PageOverview() -> impl IntoView {
    view! {
        <Article>
            ...
            <P>
                "It provides \"ready to be used\" components 组件 for capturing user input through buttons, inputs fields, select inputs, sliders, date & time inputs or even a rich text editor. "
